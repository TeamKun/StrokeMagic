...
public class FakeSender implements Entity {
    private final UUID uuid = UUID.randomUUID();
    private final String name = "FakePlayer";
    private Location location;

    public FakeSender(Location location) {
    ...
    public @NotNull List<Entity> getNearbyEntities(double x, double y, double z) {
        return Bukkit.selectEntities(this, String.format("@e[distance=0..%f]",
                new Vector(x, y, z).distance(new Vector(0, 0, 0))));
    }
